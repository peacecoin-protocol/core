...
import { PCETokenV8 } from "./PCETokenV8.sol";
...
contract PCECommunityTokenV8 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    */
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV8 pceToken = PCETokenV8(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV8 to = PCECommunityTokenV8(toTokenAddress);
