...
import { PCETokenV6 } from "./PCETokenV6.sol";
...
/// @custom:oz-upgrades-from PCECommunityTokenV4

contract PCECommunityTokenV6 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    /*
        keccak256(
            "TransferFromWithAuthorization(address owner,address spender,address to,
    ...
    */
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV6 pceToken = PCETokenV6(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV6 to = PCECommunityTokenV6(toTokenAddress);
    ...
    */
    ...
    function transferFromWithAuthorization(
        address owner, address spender, address to, uint256 displayAmount, uint256 validAfter, uint256 validBefore, bytes32 nonce, uint8 v, bytes32 r, bytes32 s
    )
        public
    {
        updateFactorIfNeeded();
        ...
        require(super.allowance(owner, spender) >= rawAmount, "Insufficient allowance");
        require(super.balanceOf(spender) >= (rawAmount + rawFee), "Insufficient balance");
        ...
        _spendAllowance(owner, spender, rawAmount);
        super._transfer(spender, to, rawAmount);
        super._transfer(spender, _msgSender(), rawFee);

        emit MetaTransactionFeeCollected(spender, _msgSender(), displayFee, rawFee);
        _mintArigatoCreation(spender, rawAmount, rawBalance, 1);
    }
