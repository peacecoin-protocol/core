...
import { PCECommunityTokenV6 } from "./PCECommunityTokenV6.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV6(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV6 newToken = PCECommunityTokenV6(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV6 target = PCECommunityTokenV6(toToken);
    ...
    function getSwapRateBetweenTokens(address fromToken, address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV6 fromTarget = PCECommunityTokenV6(fromToken);
        PCECommunityTokenV6 toTarget = PCECommunityTokenV6(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV6 target = PCECommunityTokenV6(fromToken);
        target.updateFactorIfNeeded();
