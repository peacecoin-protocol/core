...
import { PCETokenV3 } from "./PCETokenV3.sol";
...
contract PCECommunityTokenV3 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV3 pceToken = PCETokenV3(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV3 to = PCECommunityTokenV3(toTokenAddress);
