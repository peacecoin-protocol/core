...
import { PCETokenV4 } from "./PCETokenV4.sol";
...
/// @custom:oz-upgrades-from PCECommunityTokenV2

contract PCECommunityTokenV4 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV4 pceToken = PCETokenV4(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV4 to = PCECommunityTokenV4(toTokenAddress);
