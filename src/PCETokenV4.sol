...
import { PCECommunityTokenV4 } from "./PCECommunityTokenV4.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV4(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV4 newToken = PCECommunityTokenV4(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV4 target = PCECommunityTokenV4(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV4 target = PCECommunityTokenV4(fromToken);
        target.updateFactorIfNeeded();
