...
import { PCETokenV5 } from "./PCETokenV5.sol";
...
contract PCECommunityTokenV5 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    */
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV5 pceToken = PCETokenV5(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV5 to = PCECommunityTokenV5(toTokenAddress);
