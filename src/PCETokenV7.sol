...
import { PCECommunityTokenV7 } from "./PCECommunityTokenV7.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV7(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV7 newToken = PCECommunityTokenV7(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV7 target = PCECommunityTokenV7(toToken);
    ...
    function getSwapRateBetweenTokens(address fromToken, address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV7 fromTarget = PCECommunityTokenV7(fromToken);
        PCECommunityTokenV7 toTarget = PCECommunityTokenV7(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV7 target = PCECommunityTokenV7(fromToken);
        target.updateFactorIfNeeded();
