...
import { PCECommunityTokenV9 } from "./PCECommunityTokenV9.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV9(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV9 newToken = PCECommunityTokenV9(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV9 target = PCECommunityTokenV9(toToken);
    ...
    function getSwapRateBetweenTokens(address fromToken, address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV9 fromTarget = PCECommunityTokenV9(fromToken);
        PCECommunityTokenV9 toTarget = PCECommunityTokenV9(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV9 target = PCECommunityTokenV9(fromToken);
        target.updateFactorIfNeeded();
