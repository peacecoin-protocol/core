...
import { PCECommunityTokenV8 } from "./PCECommunityTokenV8.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV8(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV8 newToken = PCECommunityTokenV8(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV8 target = PCECommunityTokenV8(toToken);
    ...
    function getSwapRateBetweenTokens(address fromToken, address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV8 fromTarget = PCECommunityTokenV8(fromToken);
        PCECommunityTokenV8 toTarget = PCECommunityTokenV8(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV8 target = PCECommunityTokenV8(fromToken);
        target.updateFactorIfNeeded();
