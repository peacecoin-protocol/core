...
import { PCETokenV7 } from "./PCETokenV7.sol";
...
contract PCECommunityTokenV7 is
    Initializable,
    ERC20Upgradeable,
    ...
    TokenSetting
{
    ...
    */
    ...
    function updateFactorIfNeeded() public {
        ...
        PCETokenV7 pceToken = PCETokenV7(pceAddress);
    ...
    */
    ...
    function swapTokens(address toTokenAddress, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV7 to = PCECommunityTokenV7(toTokenAddress);
    ...
    */
        ...
        public
    {
        ...
        require(super.allowance(from, spender) >= rawAmount, "Insufficient allowance");
