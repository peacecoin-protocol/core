...
import { PCECommunityTokenV5 } from "./PCECommunityTokenV5.sol";
    ...
    NativeMetaTransaction
{
        ...
        public
    {
        ...
        BeaconProxy proxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                PCECommunityTokenV5(address(0)).initialize.selector,
                name,
                symbol,
                lastModifiedFactor
            )
        ...
        PCECommunityTokenV5 newToken = PCECommunityTokenV5(newTokenAddress);
    ...
    function getSwapRate(address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV5 target = PCECommunityTokenV5(toToken);
    ...
    function getSwapRateBetweenTokens(address fromToken, address toToken) public view returns (uint256) {
        ...
        PCECommunityTokenV5 fromTarget = PCECommunityTokenV5(fromToken);
        PCECommunityTokenV5 toTarget = PCECommunityTokenV5(toToken);
    ...
    function swapFromLocalToken(address fromToken, uint256 amountToSwap) public {
        ...
        PCECommunityTokenV5 target = PCECommunityTokenV5(fromToken);
        target.updateFactorIfNeeded();
